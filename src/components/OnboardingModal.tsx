...
const screens = [
  ...
  },
  {
    ...
    steps: [
      'Pick a compliment or write your own',
      'We wrap it in a pretty mint',
      'They get a notification someone is thinking of them',
      'They tap to unwrap your handpicked message',
    ],
  },
  {
    emoji: '💚',
  ...
  },
  {
    ...
    steps: [
      'Pick a compliment to start the chain',
      'Send it to up to 3 people at once',
      'Each person passes it forward within 48 hours',
      'Use a Pause Token for 48 extra hours anytime',
    ],
  },
];
